...
if __name__ == '__main__':
    def modify_parser(parser):
        parser.set_defaults(
            comment='{obj}_mvtec_{admode}_E{epochs}',
            objective='clip',
            dataset='mvtec',
    ...
    args = default_argsparse(
        lambda s: f"{s} This specific script comes with a default configuration for training CLIP with MVTec-AD.", modify_parser
    )
